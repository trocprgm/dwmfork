...
const char *spcmd1[] = {"st", "-n", "Upad", "-g", "120x60", "-e", "tmux",  NULL };
const char *spcmd5[] = {"st", "-n", "Opad", "-g", "120x60", "-e", "tmux",  NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_n,   tagtoprev,      {0} },
